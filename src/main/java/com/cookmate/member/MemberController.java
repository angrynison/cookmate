...
public class MemberController {
    ...
    public ResponseEntity<Long> signupUser(@RequestBody MemberRequestDto.JoinRequest joinRequest) {
    ...
    public ResponseEntity<MemberResponseDto.JwtTokenResponse> loginUser(@RequestBody MemberRequestDto.LoginRequest loginRequest) {
         return ResponseEntity.ok(memberService.login(loginRequest));
    }

    // 회원 프로필 생성
    @PostMapping("/user/profile")
    public ResponseEntity<Long> createProfile(@AuthenticationPrincipal UserDetails userDetails, @RequestBody MemberRequestDto.ProfileRequest profileRequest) {
    ...
    // 관리자 등록
    @PostMapping ("/admin")
    ResponseEntity<Long> signupAdmin(@RequestBody MemberRequestDto.JoinRequest joinRequest) {
    ...
    ResponseEntity<MemberResponseDto.JwtTokenResponse> loginAdmin(@RequestBody MemberRequestDto.LoginRequest loginRequest) {
